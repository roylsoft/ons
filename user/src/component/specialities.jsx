  ...
  return (
    <main className='main-container'>
      <div className='px-2 mt-3'>
        ...
        <Link to='/addspeciality' className='btn btn-success'>+ Add speciality</Link>
          ...
          <tbody>
            {
              value.map( sp =>(
                <tr>
                  ...
                  <td>{sp.codep}</td>
                  <td>
                    <Link to={'/editspec/'+sp.codesp} className='btn btn-info btn-sm me-2 bi-pencil-square'></Link>
