...
function Staffdashboad() {
    ...
    const mycourses = () => {
        axios.get('https://server-six-bice.vercel.app/auth/courselist/' + mat)
            .then(result => {
            ...
            <main >
                ...
                <div className='px-2 mt-4 pt-3'>
                    <div className='px-2 mt-4 pt-3'>
                        ...
                        {/* <Link to={`/assigncamarks/${mat}`} className='btn btn-success mx-5'>
                                <ImCalculator className='icon' /> Assign CA's marks
                            </Link>
                      
                            <Link to={`/assignexammarks/${mat}`} className='btn btn-success mx-5'>
