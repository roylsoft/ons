...
const Student1 = () => {
    ...
    const handlelogout =()=>{
      axios.get('https://ons-client.vercel.app/student/logout')
      .then(result=>{
    ...
    <div className='d-flex justify-content-center align-items-center vh-100 loginPage'>
        <div className='p-5 rounded w-100 border loginForm'>
            <div className='p-2 d-flex justify-content-center shadow'>
              <h4>Florence Institute of Telecommunication (FINTEL)</h4>
            </div>
            <div className='p-1 d-flex justify-content-around mt-3'>
               
                <div className='px-2 pt-2 pb-3 border shadow-sm w-5'>
                  <div className='text-center pb-1'>
                    <img src={"https://ons-client.vercel.app/image/"+student.pic} alt="photo" className='profile_pic'/>
                  </div> <hr />
