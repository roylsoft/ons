...
function Timetable() {
  ...
  const handleCellChange = async (code, field, value) => {
    try {
      ...
      await axios.put(`https://server-six-bice.vercel.app/auth/updatecourse/${code}`, { colone, valeur });
    ...
    <main className='main-container'>
      <div className='px-2 mt-3'>
        ...
        <div class="row mt-1 mb-2">
          ...
          {/* <div class="col"><Link to='/addstudent' className='btn btn-success'></Link></div> */}
        </div>
        <hr />
