...
function Studentreg() {
    ...
    return (
        <main className='main-container'>
            <div className='d-flex justify-content-center mt-5 mb-4 align-items-center'>
                <div className='p-3 border-rounded w-60 bolder loginForm'>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className='d-flex justify-content-center'>
                            <h6> Copy your Matricule from the top and click here to log in <button type='button' className='btn btn-success '
