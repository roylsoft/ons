...
function Solvability1() {
    ...
    const solvability = async () => {
        const url = 'https://ons-client.vercel.app/student/solvability/data'
    ...
    const update = async (value) => {
        try {
            ...
            await axios.put(`https://ons-client.vercel.app/student/uprec`, { valeur });
        } catch (error) {
            console.error(error);
        }
    };
    ...
    const handleCellChange = async (mat, field, value) => {
        try {
            ...
            // Mettre à jour la valeur dans la base de données MySQL via une requête API
            await axios.put(`https://ons-client.vercel.app/student/solvability/${mat}`, { colone, valeur, codesp: values.codesp });
    ...
    const handleUpdate = async (mat, field, value) => {
